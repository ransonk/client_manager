...
import { setCurrentUser, setCurrentClient, fetchClients, updateProgress, fetchTodaysPlans, setTodaysPlans, setTrainerClients, fetchWorkouts, setWorkouts, fetchIntensities, setIntensities, fetchWorkoutPlans, setAllWorkoutPlans, fetchAllWorkoutPlans } from "./store/users";
...
function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const workoutPlans = await fetchAllWorkoutPlans(user.id)
