...
Revision ID: 7e05479dda4c
Revises: 697475471f01
Create Date: 2020-12-29 17:23:59.230914
...
revision = '7e05479dda4c'
down_revision = '697475471f01'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('pushCount', sa.String(length=40), nullable=False),
    sa.Column('pullCount', sa.String(length=40), nullable=False),
    sa.Column('pushScore', sa.String(length=40), nullable=False),
    sa.Column('pullScore', sa.String(length=40), nullable=False),
