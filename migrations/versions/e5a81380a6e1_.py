...
Revision ID: e5a81380a6e1
Revises: 11c09a1ff1d4
Create Date: 2021-01-13 22:31:48.455037
...
revision = 'e5a81380a6e1'
down_revision = '11c09a1ff1d4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('workout1Score', sa.String(length=40), nullable=True),
    sa.Column('workout2', sa.String(length=40), nullable=True),
    sa.Column('workout2Score', sa.String(length=40), nullable=True),
    sa.Column('workout3', sa.String(length=40), nullable=True),
    sa.Column('workout3Score', sa.String(length=40), nullable=True),
    sa.Column('workout4', sa.String(length=40), nullable=True),
    sa.Column('workout4Score', sa.String(length=40), nullable=True),
    sa.Column('workout5', sa.String(length=40), nullable=True),
    sa.Column('workout5Score', sa.String(length=40), nullable=True),
    sa.Column('workout6', sa.String(length=40), nullable=True),
    sa.Column('workout6Score', sa.String(length=40), nullable=True),
    sa.Column('workout7', sa.String(length=40), nullable=True),
    sa.Column('workout7Score', sa.String(length=40), nullable=True),
    sa.Column('workout8', sa.String(length=40), nullable=True),
    sa.Column('workout8Score', sa.String(length=40), nullable=True),
