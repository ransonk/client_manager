...
def create_workout_history(id):
    ...
    if form.validate_on_submit():
        ...
        workouthistory = History(
            name=form.data['name'],
            workout1=form.data['workout1'],
            workout1Score=form.data['workout1Score'],
            workout2=form.data['workout2'],
            workout2Score=form.data['workout2Score'],
            workout3=form.data['workout3'],
            workout3Score=form.data['workout3Score'],
            workout4=form.data['workout4'],
            workout4Score=form.data['workout4Score'],
            workout5=form.data['workout5'],
            workout5Score=form.data['workout5Score'],
            workout6=form.data['workout6'],
            workout6Score=form.data['workout6Score'],
            workout7=form.data['workout7'],
            workout7Score=form.data['workout7Score'],
            workout8=form.data['workout8'],
            workout8Score=form.data['workout8Score'],
            date=form.data['date'],
            client_id=id,
            trainer_id=form.data['trainer_id']
        )
